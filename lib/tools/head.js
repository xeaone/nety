...
module.exports = class Head {
    ...
    constructor (option) {
        ...
        this.cookiePath = option.cookie.path || '';
        this.cookieDomain = option.cookie.domain || '';
        this.cookieName = option.cookie.name || 'cookie';
        this.cookieSameSite = option.cookie.sameSite || 'Strict';
        this.cookieHttpOnly = option.cookie.httpOnly === false ? false : true;
        this.cookieSecure = option.cookie.secure === undefined ? false : option.cookie.secure === true ? true : false;

        // Number of seconds until the cookie expires.
        // A zero or negative number will expire the cookie immediately.
        // If both (Expires and Max-Age) are set, Max-Age will have precedence.
        this.cookieMaxAge = option.cookie.maxAge || '';

        // <day-name>, <day> <month> <year> <hour>:<minute>:<second> GMT
        this.cookieExpires = option.cookie.expires || '';
